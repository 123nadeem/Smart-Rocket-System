...
class Rocket():
    ...
    def sum_of_all_torques(self, forces):
        ...
        sum = self.torque(self.TRUSTER_1, forces[0]) + self.torque(self.TRUSTER_2, forces[1]) + self.torque(
            self.TRUSTER_3, forces[2]) + self.torque(self.TRUSTER_4, forces[3])

        return self.mag * sum.item()
